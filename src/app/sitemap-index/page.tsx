  ...
  const sitemaps = [
    {
      name: 'Main Sitemap',
      url: '/sitemap.xml',
      description: 'Primary sitemap index',
    },
    {
      name: 'Sitemap 2',
      url: '/sitemap2.xml',
      description: 'Additional pages sitemap',
    },
    {
      name: 'Sitemap 3',
      url: '/sitemap3.xml',
      description: 'Extended content sitemap',
    },
    { name: 'Atom Feed', url: '/atom.xml', description: 'RSS/Atom feed' },
    {
      name: 'Atom Feed 1',
      url: '/atom1.xml',
      description: 'Additional RSS/Atom feed',
    },
  ];
        ...
        <div className="bg-white shadow-lg rounded-lg p-8">
          ...
          <div className="mt-8 p-4 bg-blue-50 rounded-lg">
            ...
            <p className="text-xs text-blue-800">
              Submit these sitemaps to Google Search Console and Bing Webmaster
              Tools to help search engines discover and index your content.
            </p>
          </div>
        </div>
      </div>
